    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-purple-800 flex flex-col rounded-3xl overflow-hidden">
      ...
      <div className="flex justify-between items-center px-4 py-2 text-white text-sm font-medium">
        <div className="flex items-center space-x-1">
          <span className="ml-4 font-bold mt-3">{currentTime || "0:00"}</span>
        </div>
      ...
      //       <button className="bg-white/90 backdrop-blur-sm rounded-full p-4 text-gray-800 shadow-lg transform hover:scale-105 transition-transform">
      //           <AddIcon 
      //             sx={{ 
      //               color: 'black', 
      //               fontSize: 32 
