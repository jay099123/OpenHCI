...
export default function HomepageLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-pink-900 flex flex-col rounded-3xl overflow-hidden">
      {/* Status Bar */}
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 -top-6 z-10">
          <div className="bg-white/20 backdrop-blur-sm rounded-full p-3">
            <button className="bg-white/80 backdrop-blur-sm rounded-full p-4 text-gray-800 shadow-lg transform hover:scale-105 transition-transform hover:bg-white/90">
                <AddIcon 
                  sx={{ 
                    color: 'black', 
                    fontSize: 32 
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 mx-4 mb-4 rounded-full px-8 py-4">
          <div className="flex items-center justify-between">
            {/* History button */}
            <button className="text-white flex flex-col items-center space-y-1 hover:text-white/80 transition-colors">
